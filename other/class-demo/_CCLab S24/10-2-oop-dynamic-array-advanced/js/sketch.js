...
function preload() {
  imgEmoji = loadImage("assets/emoji.png");
  imgParticle = loadImage("assets/sprite.png");
}
...
class Particle {
  ...
  display() {
    ...
    blendMode(ADD);
    tint(255, 180, 10, 255 * this.lifespan)
    image(imgParticle, 0, 0, this.rad * 2, this.rad * 2);
